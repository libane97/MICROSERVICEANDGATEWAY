...
import dj.djibgate.config.audit.AuditEventConverter;
import dj.djibgate.domain.PersistentAuditEvent;
...
import static dj.djibgate.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
