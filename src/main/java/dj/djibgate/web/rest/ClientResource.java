...
import dj.djibgate.domain.Client;
import dj.djibgate.repository.ClientRepository;
...
/**
 * REST controller for managing {@link dj.djibgate.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ClientResource {
    ...
    private static final String ENTITY_NAME = "djibGatesClient";
